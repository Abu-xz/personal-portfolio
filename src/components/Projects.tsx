  ...
  const projects = [
    {
      ...
      description: "A full-stack, feature-rich e-commerce platform focused on men's fashion. It features a well-structured user interface and an intuitive admin dashboard for seamless order and inventory management.",
    ...
    },
    {
      ...
      description: "Freelance startup providing a range of digital services, including web design, web development, 3D modeling, FiveM server scripting, digital marketing, and poster design.",
    ...
    {
      title: "OLX Clone",
      description: "A fully functional OLX-style marketplace, enabling users to list, search, and buy/sell products seamlessly.",
    ...
    {
      title: "Netflix Clone",
      description: "A sleek Netflix-inspired streaming platform with user authentication, dynamic content fetching, and smooth UI transitions.",
    ...
    },
    {
      ...
      description: "A lightweight, real-time chat application using WebSockets for instant messaging and a responsive UI.",
      ...
      <div className="section-container">
        ...
        >
          ...
          <p className="section-subtitle mx-auto">
            A showcase of my work, ranging from web applications to innovative solutions.
          </p>
        </motion.div>
